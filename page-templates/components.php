  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        ...
        <h2>Paragraphs</h2>
        <h3>small</h3>
        <p class="small">Paragraph Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus totam doloremque
          iste laborum
          aliquam, repudiandae, ipsam nostrum a nemo dolore corrupti animi. Facilis nostrum vitae provident, praesentium
          recusandae sint repellat.</p>
        <h3>regular</h3>
        <p>Paragraph Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus totam doloremque iste laborum
          aliquam, repudiandae, ipsam nostrum a nemo dolore corrupti animi. Facilis nostrum vitae provident, praesentium
          recusandae sint repellat.</p>
        <h3>large</h3>
        <p class="large">Paragraph Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus totam doloremque
          iste laborum
          aliquam, repudiandae, ipsam nostrum a nemo dolore corrupti animi. Facilis nostrum vitae provident, praesentium
          recusandae sint repellat.</p>
        <div class="spacer-sections"></div>
        ...
        <div style="background: white;">
          ...
          <a class="button triangleleft triangleright" href="#">Button</a>
