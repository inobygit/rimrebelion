...
// prettier-ignore
$heading = __("Chcete byť vždy informovaný?", "rimrebelion");
$text = __("Zapíšte sa do nášho newslettera a dostávajte informácie o novinkách, akciách a výpredajoch medzi prvými!", "rimrebelion");
